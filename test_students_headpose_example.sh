...
sudo docker run --name students_headpose_container -v students_headpose_volume:/home/username --rm -it -d students_headpose_image bash
sudo docker exec -w /home/username/ students_headpose_container python images_framework/alignment/students_headpose/test/students_headpose_test.py --input-data images_framework/alignment/students_headpose/test/example.tif --database biwi --gpu 0 --save-image
