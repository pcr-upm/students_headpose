...
sudo docker exec -w /home/username/ students_headpose_container python images_framework/alignment/students_headpose/test/students_headpose_test.py --input-data images_framework/alignment/students_headpose/test/example.tif --database aflw --gpu 0 --backbone resnet --save-image
...
rsync --delete -azvv /var/lib/docker/volumes/students_headpose_volume/_data/images_framework/output/images/ output
